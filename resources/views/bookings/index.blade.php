...
@section('widget-title', 'Create Booking')
@section('widget-desc', '')
@section('breadcrumb')
...
@push('js')
<script src="{{ asset('my_js/bookings/bookings.js') }}"></script>
@endpush
    ...
    <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false" data-widget-deletebutton="false">
        ...
        <div>
            ...
            <div class="widget-body">
                <div class="row">
                    <form action="{{ url('/store-booking') }}" method="post" id="wizard-1" novalidate="novalidate">
                        {{ csrf_field() }}
                        <div id="bootstrap-wizard-1" class="col-sm-12">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab1">
                                    @include('bookings.basic_info')
                                </div>
                                <div class="tab-pane" id="tab2">
                                    @include('bookings.contact_details')
                                </div>
