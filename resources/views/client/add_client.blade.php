...
@section('content')
    ...
    <table id="clients" class="table table-striped table-bordered table-hover" width="100%">
        <thead>
        <tr>
            <th>ID</th>
            <th>Name</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body no-padding">
                    ...
                    <form id="add-menu-form" class="smart-form" action="{{ url('store-client') }}" method="post">
                        {{ csrf_field() }}
                        <fieldset>
                            <section>
                                <div class="row">
...
@push('js')
<script src="{{ URL::asset('my_js/client/client.js') }}"></script>
@endpush