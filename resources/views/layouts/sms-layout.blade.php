...
<script src="{{ URL::asset('js/libs/jquery-2.1.1.min.js') }}"></script>
...
<script src="{{ URL::asset('js/plugin/delete-table-row/delete-table-row.min.js') }}"></script>

<script src="{{ URL::asset('js/plugin/summernote/summernote.min.js') }}"></script>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#compose-mail,#compose-mail-mini").click(function() {
            loadURL("compose", $('#inbox-content > .table-wrap'));
        })
